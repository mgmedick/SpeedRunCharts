...
namespace SpeedRunApp.Interfaces.Repositories
{
    ...
    {
        IEnumerable<SpeedRunSummaryView> GetSpeedRunSummaryResults(int category, int topAmount, int? orderValueOffset, int? categoryTypeID);
        IEnumerable<SpeedRunSummaryList> GetSpeedRunSummaryLists(Expression<Func<SpeedRunSummaryList, bool>> predicate = null);
