...
namespace SpeedRunApp.Model.ViewModels
{
    public class SpeedRunGridViewModel
    {
        ...
        public SpeedRunGridViewModel(string sender, IEnumerable<IDNamePair> categoryTypes, IEnumerable<GameDisplay> games, IEnumerable<CategoryDisplay> categories, IEnumerable<LevelDisplay> levels, IEnumerable<SpeedRun> speedRuns = null)
        {
            Sender = sender;
