<template>
    ...
    <div v-else id="divSpeedRunEdit" class="container">
        ...
        <div class="form-group row no-gutters" v-if="item.speedRunVM.statusType.id != 0">
            <label class="col-sm-2 col-form-label">Verified Date</label>
            <div class="col-sm-10">
                <datepicker class="form-control" :date="item.speedRunVM.verifyDateString" container="#editModal" style="width:220px;"></datepicker>
            </div>
        </div>
        <div class="form-group row no-gutters">
            ...
            <div class="col-sm-10">
                <div style="width:300px;">
                    <vue-next-select v-model="playerids" :options="item.players" label-by="name" value-by="id" multiple taggable></vue-next-select>
                </div>
            </div>
        </div>
        <div class="form-group row no-gutters">
        ...
        <div class="form-group row no-gutters" v-if="item.speedRunVM.level">
