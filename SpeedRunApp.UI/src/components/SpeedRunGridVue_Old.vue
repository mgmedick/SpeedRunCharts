<template>
    <div>    
        ...
        <div class="mt-2 mx-0 grid-container container" style="">
    ...
    export default {
        ...
        methods: {
            ...
            initGrid(tableData) {
                ...
                var columns = [
                    { title: "", field: "id", formatter: that.optionsFormatter, hozAlign: "center", headerSort:false, responsive:0, minWidth:30, maxWidth:50, responsive:0  },
                    { title: "Rank", field: "rank", sorter: "number", formatter: that.rankFormatter, headerFilter:"select", headerFilterParams:{ values:true, multiselect:true }, headerFilterFunc: that.rankHeaderFilter, responsive:0, minWidth:40, maxWidth:75, responsive:0  },
                    { title: "Players", field: "players", sorter:that.playerSorter, formatter: that.playerFormatter, headerFilter:"select", headerFilterParams:{ values:players, multiselect:true }, headerFilterFunc: that.playerHeaderFilter, minWidth:125, responsive:0 },
                    { title: "Platform", field: "platformName", headerFilter:"select", headerFilterParams:{ values:true, multiselect:true }, headerFilterFunc:"in", minWidth:100, responsive:2 },
                    { title: "Time", field: "primaryTime.ticks", formatter: that.primaryTimeFormatter, sorter: "number", minWidth:100, maxWidth:125, responsive:0 },
                    { title: "Submitted Date", field: "dateSubmitted", formatter: that.dateFormatter, formatterParams:{ outputFormat:"MM/DD/YYYY", tooltipFieldName:"relativeDateSubmittedString" }, headerFilter: that.dateEditor, headerFilterFunc: that.dateHeaderFilter, minWidth:140, maxWidth:170, responsive:2 },
                    { title: "Verified Date", field: "verifyDate", formatter:that.dateFormatter, formatterParams:{ outputFormat:"MM/DD/YYYY", tooltipFieldName:"relativeVerifyDateString" }, headerFilter: that.dateEditor, headerFilterFunc: that.dateHeaderFilter, minWidth:140, maxWidth:170, responsive:3  },
                ...
                distinctVariables?.forEach(variable => { 
                    columns.push({ title: variable.name, field: variable.id.toString(), headerFilter:"select", headerFilterParams:{ values:true, multiselect:true }, headerFilterFunc:"in", minWidth:50, maxWidth:150, responsive:3 },)
                });

                columns.push({ title: "Comment", field: "comment", formatter: that.commentFormatter, hozAlign: "center", headerSort:false, minWidth:30, maxWidth:100, responsive:1 });
