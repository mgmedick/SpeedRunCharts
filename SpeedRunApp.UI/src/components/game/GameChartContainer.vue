        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6" style="min-height:400px;">
                    ...
                    <div v-else style="height:100%;">
                        <game-speedrun-count-bar-chart chartconainerid="divGameChart1" :tabledata="tabledata" :categorytypeid="categorytypeid" :categoryid="categoryid" :categories="categories" :levels="levels" :variables="variables" :showmilliseconds="showmilliseconds" :subcaption="subcaption"></game-speedrun-count-bar-chart>                                                 
            ...
            <div class="row">
                <div class="col-lg-12" style="min-height:800px;">
                    ...
                    <div v-else style="height:100%;">
                        <game-speedrun-count-doughnut-chart chartconainerid="divGameChart3" :tabledata="tabledata" :categorytypeid="categorytypeid" :categoryid="categoryid" :categories="categories" :levels="levels" :subcategoryvariablevaluetabs="subcategoryvariablevaluetabs" :showmilliseconds="showmilliseconds" :subcaption="subcaption"></game-speedrun-count-doughnut-chart>                                        
