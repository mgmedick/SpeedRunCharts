<template>
    <div class="speedRunSummary">
        <div class="row no-gutters p-2 px-3">
            ...
            <div class="col-auto ps-2 pe-0 align-self-end">
        ...
        <div class="p-2 d-flex">
            <div class="col p-0 align-self-end" style="overflow:hidden;">
                <div>   
                    ...
                    <div class="text-secondary fw-bold" style="font-size: 14px;">
                ...
                <div>
                    <span v-if="item.categoryTypeName" class="badge badge-secondary fw-normal me-1 mt-1 text-secondary" style="white-space:normal; text-align:left;">{{ item.categoryTypeName }}</span>
                    <span v-if="item.categoryName" class="badge badge-secondary fw-normal me-1 mt-1 text-secondary" style="white-space:normal; text-align:left;">{{ item.categoryName }}</span>
                    <span v-if="item.levelName" class="badge badge-secondary fw-normal me-1 mt-1 text-secondary" style="white-space:normal; text-align:left;">{{ item.levelName }}</span>
                    <template v-for="(subCategoryVariableValue, index) in item.subCategoryVariableValueNames">
                        <span class="badge badge-secondary fw-normal me-1 mt-1 text-secondary" style="white-space:normal; text-align:left;">{{ subCategoryVariableValue }}</span>
                    </template>
                </div>                      
            </div>
