<template>
    <div class="btn-dropdown dropdown" :class="{ show : state }" @click="toggleDropdown">
        <button class="btn dropdown-toggle nowrap-elipsis" :class="btnclasses" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ref="btn">
            <slot name="text"></slot>
        </button>
