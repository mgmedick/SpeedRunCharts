...
namespace SpeedrunComSharp.Model
{
    public class Game : IElementWithID
    {
        ...
        #region Embeds
        public ReadOnlyCollection<string> PlatformIDs { get; set; }
        public ReadOnlyCollection<string> RegionIDs { get; set; }
        /// <summary>
        /// null when embedded
        /// </summary>
        /// 
        public ReadOnlyCollection<Moderator> Moderators { get; set; }
        public Lazy<ReadOnlyCollection<User>> moderatorUsers { get; set; }
        public ReadOnlyCollection<User> ModeratorUsers { get { return moderatorUsers.Value; } }
        public Lazy<ReadOnlyCollection<Platform>> platforms { get; set; }
        public ReadOnlyCollection<Platform> Platforms { get { return platforms.Value; } }
        public Lazy<ReadOnlyCollection<Region>> regions { get; set; }
        ...
        public Lazy<ReadOnlyCollection<Level>> levels { get; set; }
